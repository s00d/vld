...
//!
//! ```rust
//! use vld_schemars::schemars_to_json;
//!
//! // Any type with schemars::JsonSchema can produce a vld-compatible JSON Schema
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        schemars_to_json, vld_schema_to_schemars, vld_to_schemars, PropertyInfo,
    };
    pub use vld::prelude::*;
}
